...
class ParentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('punter','bet_date','bet_week','bet_number','bet_legs','bet_event','bet_amount','bet_odds','bet_return','bet_win','bet_cashed')
...
class MultiAdmin(admin.ModelAdmin):
    ...
    search_fields = ('parent','bet_leg','bet_type','bet_team','bet_opposition','bet_home','bet_odds','bet_win')
